...
**ACORD 125 Fields to Extract:**
1. applicant_name - Named insured / business name
2. mailing_address - Full mailing address
3. business_type - Type of business/entity (Corporation, LLC, etc.)
4. years_in_business - Years the business has been operating
5. effective_date - Requested policy effective date (ISO format YYYY-MM-DD)
6. expiration_date - Requested policy expiration date (ISO format YYYY-MM-DD)
7. prior_carrier - Current/prior insurance carrier name
8. prior_policy_number - Current/prior policy number
9. prior_premium - Current/prior annual premium
10. claims_history - List of prior claims (date, type, amount)
11. coverage_types_requested - List of coverage types (Property, GL, Umbrella, etc.)
...
2. total_insured_value - Sum of all property values
3. requested_limits - Requested coverage limits (building, contents, BI)
4. deductibles - Requested deductible amounts
5. special_conditions - Any special conditions or requirements
6. loss_history - Property loss history details
7. mortgagee_info - Mortgagee/additional insured information
...
{{
  "acord_125": {{
    ...
    "claims_history": [
      {{"date": "2023-05-15", "type": "Property - Water Damage", "amount": "$12,500"}},
      {{"date": "2022-11-20", "type": "Liability - Slip and Fall", "amount": "$8,000"}}
    ],
    "coverage_types_requested": ["Commercial Property", "General Liability", "Business Auto", "Umbrella"]
  }},
  "acord_140": {{
    "property_locations": [
      {{
    ...
    "loss_history": [
      {{"date": "2023-05-15", "location": "123 Main St", "cause": "Water Damage", "amount": "$12,500", "status": "Closed"}}
    ],
    "mortgagee_info": [
