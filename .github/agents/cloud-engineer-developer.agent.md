...
tools:
  ['runCommands', 'com.microsoft/azure/*', 'microsoftdocs/mcp/*', 'edit/createFile', 'edit/createDirectory', 'edit/editFiles', 'search/fileSearch', 'search/listDirectory', 'search/readFile', 'todos', 'fetch']
---
